        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-group" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px">
                ...
                <div class="wp-block-buttons">
                    <!-- wp:button {"backgroundColor":"background","textColor":"foreground","align":"center","style":{"spacing":{"padding":{"top":"14px","bottom":"14px","left":"32px","right":"32px"}},"border":{"radius":"100px"}},"fontSize":"paragraph"} -->
                    <div class="wp-block-button aligncenter has-custom-font-size has-paragraph-font-size"><a class="wp-block-button__link has-foreground-color has-background-background-color has-text-color has-background wp-element-button" href="<?php echo get_site_url(); ?>/blog" style="border-radius:100px;padding-top:14px;padding-right:32px;padding-bottom:14px;padding-left:32px" target="_blank" rel="noreferrer noopener"><?php echo esc_html__( 'Explore', 'travel-init' ); ?></a></div>
                    <!-- /wp:button -->
                </div>
                <!-- /wp:buttons -->
